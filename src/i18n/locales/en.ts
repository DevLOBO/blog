...
const baseStrings = {
  "site.title": "Franco Hernandez",
  "site.desc":
    "I'm a software developer focused on backend with Java and automation using Python. I share day-to-day technical experiences and explore the use of artificial intelligence in software development and automation.",
};

const ENLocale: I18nStrings = {
  ...baseStrings,
  "hero.title": "Building Smart Software, One Line at a Time",
  "hero.body":
    "I'm a backend developer specializing in Java, passionate about automation with Python and the integration of artificial intelligence. Here, I share technical solutions, innovative ideas, and tools that are reshaping how we build software.",
  "hero.beforeReadme": "Read my blog posts or check",
  "hero.readme": "About",
